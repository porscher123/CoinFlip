#############################################################################
# Makefile for building: CoinFlip
# Generated by qmake (3.1) (Qt 6.2.3)
# Project:  CoinFlip.pro
# Template: app
# Command: D:\Qt\6.2.3\mingw_64\bin\qmake.exe -o Makefile CoinFlip.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: CoinFlip.pro D:/Qt/6.2.3/mingw_64/mkspecs/win32-g++/qmake.conf D:/Qt/6.2.3/mingw_64/mkspecs/features/spec_pre.prf \
		...
		CoinFlip.pro \
		D:/Qt/6.2.3/mingw_64/lib/Qt6Multimedia.prl \
		...
		res.qrc
	$(QMAKE) -o Makefile CoinFlip.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
